package br.com.cotemig.fotosbootcamp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pick_button.setOnClickListener {
            ...
            //Pergunta se a versão interna do SDL do dispositivo do usuário é maior que a versão Marshimellow
        ...
        open_camera_button.setOnClickListener {
            ...
            //Checa se as permisões de acesso à Camera e ou acesso a gravar informações externas estão permitidas pelo usuário
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
